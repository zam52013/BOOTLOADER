...
#include <string.h>
	...
	unsigned char USART1_RECEIVE_DATA[Usart_size];
#endif
#ifdef USINGE_USART1_DMA_T
	unsigned char USART1_SEND_DATA[Usart_size];
#endif
#ifdef USINGE_USART2_DMA_R
	unsigned char USART2_RECEIVE_DATA[Usart_size];
#endif
#ifdef USINGE_USART2_DMA_T
	unsigned char USART2_SEND_DATA[Usart_size];
#endif
#ifdef USINGE_USART3_DMA_R
	 unsigned char USART3_RECEIVE_DATA[Usart_size];
#endif
#ifdef USINGE_USART3_DMA_T
	unsigned char USART3_SEND_DATA[Usart_size];
#endif
#ifdef USINGE_UART4_DMA_R
	unsigned char UART4_RECEIVE_DATA[Usart_size];
#endif
#ifdef USINGE_UART4_DMA_T
	unsigned char UART4_SEND_DATA[Usart_size];
#endif
